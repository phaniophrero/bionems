...
class Product(models.Model):
    ...
    ingredients = models.ManyToManyField('Ingredient',related_name='product_ingredients', blank=True)
    # ingredients = ArrayField(models.CharField(max_length=200), blank=True, default=['ingredient1', 'ingredient2'])
